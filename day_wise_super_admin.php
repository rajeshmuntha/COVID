                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <ul class="dropdown-menu animate__animated animate__flipInX">
                                <li><a class="dropdown-item active" href="day_wise_super_admin.php? = Day wise reports for super admin">Day Wise</a></li>
...
<section class="pt-5 mt-5 animate__animated animate__fadeInRight">
  <div class="container p-4 shadow-lg rounded rounded-4 table-responsive ">
    ...
    <thead>
        <tr><th colspan="3" class="bg-light text-primary fs-4">DAY WISE REGISTRATIONS &nbsp; <i class="bi bi-bookmark-star-fill"></i></th></tr>
    </thead>
                <tr>
