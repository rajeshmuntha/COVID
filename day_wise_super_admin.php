...
.tb2 {
    ...
    width: 50px; 
      ...
      <body>  
                ...
                <table width="900" class="super-admin-day-wise-data">
                <tr><td>	
                    </td>
 ...
 {   
     ...
     ?>
           ...
           <table align="center" id="tb" border='1'>  
            <tr>
            <td colspan='10'>Test Results Duration : <?php echo $_POST["from_date"].' to '.$_POST["to_date"]; ?>
            </td>
             </tr>
                <tr>  
                     <th width="20" align="center">SL.NO</th>  
                     <th width="100" align="center">Test Location</th>  
                     <th width="60" align="center">rT-PCR</th>  
                     <th width="80" align="center">RTK-Antigen</th> 
                     ...
                     <th width="90" align="center">SALIVA PCR</th>
                     <th width="100" align="center">Influenza <br>A & B</th>
