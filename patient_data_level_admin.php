...
<section style="margin-top: 120px;" class=" animate__animated animate__fadeInRight">
  <div class="container p-4 table-responsive shadow-lg rounded rounded-4">
    <table class=" table table-bordered">
        <tr>
          <th class="text-center bg-light text-primary fs-4">PATIENT RECORDS &nbsp; <i class="bi bi-file-earmark-text-fill"></i></th>        
        <tr>
        	<td align="right">
           <form action="patient_data_level_admin_res.php? = Record search data" method="post" >
