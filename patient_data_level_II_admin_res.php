...
<div id="response" class="<?php if(!empty($type)) { echo $type . " display-block"; } ?>"><?php if(!empty($message)) { echo $message; } ?></div>
    <div style="margin-top: 80px;" class="outer-scontainer">
  ...
  <div class="container p-4 shadow-lg rounded rounded-4 table-responsive">   
        ...
        <tr>
            ...
            <table id="des" class="table table-bordered table-hover">
            <thead align='center'>
                <tr>
                    <th class="bg-light align-middle" width='40'>No.</th>
                    <th class="bg-light align-middle" width='100'>IC/Passport No.</th>
                    <th class="bg-light align-middle" width='280'>Patient Name</th>
                    <th class="bg-light align-middle" width='100'>Test Obtained</th>
                    <th class="bg-light align-middle" width='80'>Reg. No.</th>
                    <th class="bg-light align-middle" width='100'>Test Location</th>
                    <th class="bg-light align-middle" width='80'>DOR</th>
                    <th class="bg-light align-middle" width="80">Kit Status</th>
                    <th class="bg-light align-middle" width='60'>Issue Kit</th>
